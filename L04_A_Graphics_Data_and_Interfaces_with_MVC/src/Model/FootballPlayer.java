...
public class FootballPlayer extends Person implements TableMember { //FootballPlayer class extends Person class
    ...
    @Override
    public String getAttribute(int n) {//returns a string attribute based on int input
        switch (n) {//Using switch statement instead of if for simplicity and maintence
            case 0:
    ...
    @Override
    public String getAttributeName(int n) {//returns attribute as string based on int input
        switch (n) {//Using switch statement instead of if for simplicity and maintence
            case 0:
                return "number";
            case 1:
